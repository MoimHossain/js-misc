# js-misc
This repository contains some handy Javascript utility classes 
or functions that were written to solve a particular problem in 
hand or just for fun! Feel free to use/contribute!

### QueryObject
This component allows us to mimic the *SQL* sintax 
with JavaScript Objects and arrays.

This function returns an object with the next methods:
...
The methods are chainable and the query is 
...
//select receives a function that will be called with the values of the array 
...
Feel free to check this out, play or enhance. Thanks!